...
# We will need our samplesheet form 17_.Rmd
# First Let's make a /analysis/19_ directory and set to working directory.

```{r import sample sheet}
# First let's read in th sample sheet we made in 17
samplesheet <- read_csv("/your_path/CLASS_2022/class_exeRcises/analysis/17_API_RNASEQ/samplesheet.csv")
...
# ANIKA I apologize that we should have done this earlier to avoid loading Gencode again :()
...
# test read in to see if we saved correct (this is pretty simple so should be fine)
g2s <- read_csv("g2s.csv")
...
counts <- read_csv("/your_path/CLASS_2022/class_exeRcises/analysis/18_running_RNAseq_NF_CORE/NF_CORE_RUN/results/salmon/salmon_merged_gene_counts.csv")
# counts <- read_csv("/scratch/Shares/rinnclass/CLASS_2022/JR/CLASS_2022/class_exeRcises/analysis/18_running_RNAseq_NF_CORE/preclass_NF_core_RUN/results/salmon/salmon_merged_gene_counts.csv")
...
# save it as an RDS
write_rds(counts_filtered, "counts_matrix.rds")
```
