...
For 6kb up/down
16363 = length(promoter_overlaps@to) = length(promoter_overlaps@from)
8306 = length(table(promoter_overlaps@from))

For 1kb up/down
12344 = length(promoter_overlaps@to) = length(promoter_overlaps@from)
7355 = length(table(promoter_overlaps@from))
